...
Decided 2026-07-07, work started 2026-07-12. There is real demand: several iPhone-owning friends want the app. **Status: M0–M2 done and verified on real hardware (2026-07-13); M3 implemented on branch `kmp-m3`, both CI workflows green and the unsigned .ipa artifact builds (2026-07-14) — remaining sign-off: sideload it and see games run on the iPhone.**
